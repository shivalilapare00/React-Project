   ...
   <div className="main1">
     <div className="main">
      ...
      <div className="grid md:grid-cols-2 gap-4 ">
        ...
        <div className="bg-green-700 p-6 rounded-md dash1">
      ...
      <div className="max-sm:grid mt-6 gap-3">
        <button
          className="bg-gray-500 text-white px-6 py-3 mx-1 rounded-md transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none btn"
