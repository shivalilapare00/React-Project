  ...
  return (
    <>
      <div className="container mx-auto p-4">
        <Link className="font-bold text-blue-400 flex items-center" to="/" text-black>
          <ChevronLeftIcon className="h-4 w-4 font-bold" />
         <h1 text-black no-underline> Dashboard</h1>
        </Link>
        <h2 className="text-2xl font-bold mb-4 pro">Products Management</h2>
        <button
          type="button"
          className="my-4"
          ...
          ref={openRef}
        >
         <p className="ps"> Add Product</p>
        </button>

        <div className="overflow-x-scroll">
          <table className="min-w-full border border-gray-300 overflow-x-scroll">
            <thead>
              <tr className="bg-gray-100 bg-transparent">
                <th className="py-2 px-4 border-2">Product ID</th>
                <th className="py-2 px-4 border-2">Product Name</th>
                <th className="py-2 px-4 border-2">Category</th>
                <th className="py-2 px-4 border-2">Price (₹)</th>
                <th className="py-2 px-4 border-2">Stock</th>
